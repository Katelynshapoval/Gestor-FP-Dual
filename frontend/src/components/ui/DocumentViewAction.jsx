...
// Compact action to open or view an existing document
const DocumentViewAction = ({
  children,
  className = "",
  iconClassName = "h-3.5 w-3.5 shrink-0 text-muted",
  ...props
}) => (
  <button
    type="button"
    className={`${documentViewActionClass} ${className}`.trim()}
    {...props}
  >
